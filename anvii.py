...
def approval():
    try:
        token  = str(md5(str(uname()).encode()).hexdigest())
        response = requests.get("https://github.com/Anvi001/approval/blob/main/anvi.txt")
...
╚═════╝     ╚═╝╚═════╝ ╚═╝ ╚═════╝    ╚═╝   ╚══════╝ 
    ...
    ------------------------------------------------------------
 [ Owners Name    : Teekhi Mirchi Anvi 🩵️]
 [ Status         : Active  ]
 [ WhatsApp       : +918873098948 ]
 [ Address        : India ]
 [ Website        : www.3iditos.com ]
